<footer class="row bg-footbar reveal-3">
  <div class="col-12">
    ...
    <div class="d-flex align-items-center justify-content-center mt-3">
      <div class="line"></div>
      <p class="text-uppercase text-white fs-3 m-3">retrouver moi sur</p>
      <div class="line"></div>
    </div>
    <div class=" d-flex justify-content-center">
      <div class="d-flex text-white justify-content-around icons">
    ...
    <div class=" row navbar navbar-dark mt-3">
      <div class="col-3">
      ...
      <ul class="col-3 navbar-nav">
        <h5 class="text-center color-style">Publications</h5>  
        ...
        <li class="nav-item">
          <a class="nav-link text-center <?php echo ($page == 'post') ? 'active' : ''; ?>" href="index.php?page=post&id=<?= $post->id ?>"><?= $post->title ?></a>
        </li>
